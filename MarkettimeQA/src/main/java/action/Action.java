...
public class Action<newImageString> extends ReptimeBase {
...
//	}
	...
	public String GenerateEmail() {
		...
		WebElement exstingEmail = driver.findElement(By.xpath("//div[contains(text(),'Email is already in use')]"));
		WebElement emailID = driver.findElement(By.xpath("//input[@id='email']"));
		WebElement confirmEmailId = driver.findElement(By.xpath("//input[@id='confirmEmail']"));
		
		
		for (int j = 45; j < 100; j++) {
			mailID = "pratham+" + j + "@markettime.com";
			
			Action action = new Action();
			action.type(emailID, mailID);
			action.type(confirmEmailId, mailID);
			if (!exstingEmail.isDisplayed()) {
